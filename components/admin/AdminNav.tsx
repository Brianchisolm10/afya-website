...
export default function AdminNav() {
  ...
  return (
    <div className="fixed inset-y-0 left-0 w-64 bg-white border-r border-gray-200 z-50 shadow-sm">
      <div className="flex flex-col h-full bg-white">
        {/* Logo */}
        <div className="flex items-center justify-center h-20 px-6 border-b border-gray-200">
          <Link href="/admin" className="flex items-center space-x-2">
            <div className="w-10 h-10 bg-gradient-to-br from-turquoise-500 to-lavender-500 rounded-lg flex items-center justify-center">
              <span className="text-white font-bold text-lg">A</span>
            </div>
            <span className="text-xl font-bold text-gray-900">AFYA</span>
          </Link>
        </div>
        ...
        <nav className="flex-1 px-4 pt-6 pb-4 space-y-1 overflow-y-auto">
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                <span className={isActive ? 'text-turquoise-600' : 'text-gray-400'}>
                  {item.icon}
                </span>
                <span>{item.name}</span>
              </Link>
